...
class tux_social extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if (get_option('tux_pay')) echo '<a class="weixin"><i class="iconfont_social weixin">&#xe601;</i><div class="weixin-popover"><div class="popover bottom in"><div class="popover-title">支付宝“' . get_option('tux_pay') . '”</div><div class="popover-content"><img width="200px" height="200px" src="' . get_option('tux_pay_qr') . '" ></div></div></div></a>';
