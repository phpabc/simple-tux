...
?>
	<?php if ( have_comments() ) : ?>
		...
		<ol class="comment_list">
			<?php wp_list_comments('callback=tux_comment'); ?>
		</ol>

		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
		<div id="comment-nav-below" class="comment_nav" role="navigation">
			<div class="nav-previous"><?php previous_comments_link( __( '上一页' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( '下一页' ) ); ?></div>
		</div>
		<?php endif; ?>
